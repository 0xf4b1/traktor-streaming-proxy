...
5. Adjust the `src/main/dist/config.properties` file to your needs. Make sure to change `beatport.license` to `windows`.
...
docker run -d --name traktor-streaming-proxy-container -p 80:80 -p 443:443 --restart always traktor-streaming-proxy
```
